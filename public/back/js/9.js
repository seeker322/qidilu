...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.getUserInfo();
    var curPageTitle = localStorage.getItem("curPageTitle");
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("permission", ["getPermissions"])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("globs", ["getUserInfo"])), {}, {
    setCurrentPageData: function setCurrentPageData(item) {
                              ...
                              : [
                                  _c(
                                    "MenuItem",
                                    {
                                      ...
                                      nativeOn: {
                                        click: function($event) {
                                          return _vm.setCurrentPageData(item)
                                        }
                                      }
                                    },
                                    [
          ...
          _c(
            ...
            [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          [_vm._v(_vm._s(_vm.curPageTitle))]
                        )
                      ],
                      1
                    ),
              ...
              _c(
                "Content",
                {
                  style: { margin: "15px 20px 10px 20px", background: "#fff" }
                },
                [_c("router-view")],
                1
              ),
