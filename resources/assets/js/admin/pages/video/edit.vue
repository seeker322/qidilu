    ...
    <div class="iframe-block">
        <el-form ref="form" :model="form" label-width="100px">
            ...
            <el-form-item label="视频地址">
              <el-input v-model="form.url" placeholder="请输入来源"></el-input>
            </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions('video', ['addVideo','editVideo','getVideoList']),
            ...
            onSubmit() {
                ...
                if(this.info){ //编辑
                    this.editVideo(params).then(res=>{
                        this.getVideoList({pid:this.pid});
                        this.$layer.close(this.layerid);
                    });
                }else{ //新增
                    this.addVideo(params).then(res=>{
                      this.getVideoList({pid:this.pid});
                        this.$layer.close(this.layerid);
                    });
                }
